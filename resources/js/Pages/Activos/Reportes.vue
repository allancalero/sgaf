                ...
                <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                    <div class="flex flex-wrap items-center justify-between gap-3">
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Filtra y exporta en CSV.</p>
                        </div>
                        <div class="flex gap-2 text-sm">
                    ...
                    <form class="mt-4 grid gap-4 sm:grid-cols-3" @submit.prevent="aplicarInventario">
                        <div>
                    ...
                    <div class="mt-6 overflow-auto">
                        <table class="min-w-full divide-y divide-gray-100 text-left text-sm text-gray-700">
                            ...
                            <tbody>
                                <tr v-for="a in props.activos" :key="a.id" class="border-b border-gray-100 hover:bg-gray-50">
                                ...
                                <tr v-if="!props.activos.length">
                                    <td colspan="8" class="px-4 py-4 text-center text-gray-500">Sin registros con los filtros aplicados</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                    <div class="flex flex-wrap items-center justify-between gap-3">
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Exporta movimientos con filtros por fecha, activo, área o responsable.</p>
                        </div>
                            <a :href="urlTrazabilidad" class="inline-flex items-center gap-2 rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-indigo-700">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.6">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v12m0 0l-4-4m4 4l4-4M4 20h16" />
                                </svg>
                                Descargar CSV
