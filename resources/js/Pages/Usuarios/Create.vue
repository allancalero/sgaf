        ...
        <template #header>
            <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500">Registro de cuentas, roles y contraseñas.</p>
                </div>
            </div>
        </template>
        <div class="py-8">
            <div class="mx-auto max-w-2xl space-y-8 sm:px-6 lg:px-8">
                <div class="rounded-2xl border border-gray-200 bg-white shadow-sm">
                    <form @submit.prevent="submit" class="space-y-5 p-8">
                        <div v-if="form.recentlySuccessful" class="rounded bg-green-100 text-green-800 px-4 py-2 text-sm mb-2">Usuario creado correctamente.</div>
